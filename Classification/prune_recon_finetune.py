...
writer = SummaryWriter(f'logs/classification/{args.tb}_{args.compression_ratio}_{args.ln}_recon_fine')
...
for epoch in range(args.epoch):  # loop over the dataset multiple times
    ...
    if best_acc < acc:
        best_acc = acc
        torch.save(model.module.state_dict(), f'./{args.result_dir}/{args.tb}/{args.tb}_{args.compression_ratio}_{args.ln}_recon_fine_best.pth')
